function [rep_cand,r_high,r_low] = candidateSpindleReplays_10282017(spikeData,timeBins,crit)
...
for n = 1:numEvents                                                         % For each time bin
    ...
    for c = 1:cells                                                         % For each place cell
        ...
        spikes = spikes(spikes >= timeBins(n,1) & spikes <= timeBins(n,2)); % Keep all its spikes that fall within the peri-ripple interval
