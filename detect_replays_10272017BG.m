function detect_replays_10272017BG(session,refs)
...
disp('Detecting spike sequences from 1st half of spindle')
[Sequences,r_high,r_low] = cand_replays(SpikeData,SpindleHalf1,periripdur,mincells);     % Get all candidate incoming replays from ripples
disp(' ')
...
function [rep_cand,r_high,r_low] = cand_replays(SpikeData,timeBins,periripdur,crit)
...
rN = size(timeBins,1);                                                       % Number of ripples
